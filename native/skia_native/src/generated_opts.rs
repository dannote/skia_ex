...
pub struct TextOpts<'a> {
    ...
    pub vertical_align: Option<Atom>,
    ...
    pub decoration: Option<Atom>,
    pub decoration_style: Option<Atom>,
    pub decoration_mode: Option<Atom>,
    pub decoration_color: Option<Term<'a>>,
...
pub fn decode_text_opts<'a>(opts: &[(Atom, Term<'a>)]) -> NifResult<TextOpts<'a>> {
    Ok(TextOpts {
        ...
        vertical_align: opt_atom_option(opts, atoms::vertical_align())?,
        direction: opt_atom_option(opts, atoms::direction())?,
        max_lines: match opt_term(opts, atoms::max_lines()) {
            Some(term) => Some(term.decode::<usize>()?),
            None => None,
        },
        ellipsis: match opt_term(opts, atoms::ellipsis()) {
        ...
        letter_spacing: opt_f32_option(opts, atoms::letter_spacing())?,
        decoration: opt_atom_option(opts, atoms::decoration())?,
        decoration_style: opt_atom_option(opts, atoms::decoration_style())?,
        decoration_mode: opt_atom_option(opts, atoms::decoration_mode())?,
        decoration_color: opt_term(opts, atoms::decoration_color()),
...
pub struct SaveLayerOpts<'a> {
    ...
    pub blur: Option<f32>,
    pub image_filter: Option<Term<'a>>,
    pub backdrop_filter: Option<Term<'a>>,
    _phantom: std::marker::PhantomData<&'a ()>,
}
pub fn decode_save_layer_opts<'a>(
    ...
    Ok(SaveLayerOpts {
        ...
        image_filter: opt_term(opts, atoms::image_filter()),
        backdrop_filter: opt_term(opts, atoms::backdrop_filter()),
        _phantom: std::marker::PhantomData,
    })
}
