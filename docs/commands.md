...
| `circle` | — | `x: number` required<br>`y: number` required<br>`radius: number` required<br>`fill: color`<br>`stroke: color`<br>`stroke_width: number`<br>`stroke_cap: stroke_cap`<br>`stroke_join: stroke_join`<br>`stroke_miter: number`<br>`blend_mode: blend_mode`<br>`image_filter: image_filter`<br>`path_effect: path_effect`<br>`color_filter: color_filter` | — | `skia_safe::Canvas::draw_circle` |
...
| `path` | `path: path` | `fill: color`<br>`stroke: color`<br>`stroke_width: number`<br>`stroke_cap: stroke_cap`<br>`stroke_join: stroke_join`<br>`stroke_miter: number`<br>`blend_mode: blend_mode`<br>`image_filter: image_filter`<br>`path_effect: path_effect`<br>`color_filter: color_filter`<br>`fill_rule: fill_rule` | — | `skia_safe::Canvas::draw_path` |
